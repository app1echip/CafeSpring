...
INSERT INTO `food` VALUES ('3c4f5b9e-fa5b-4366-8d96-c586253c436b','拿铁咖啡','咖啡',16.00,34,'意大利浓缩咖啡与牛奶的经典混合',NULL,53),('42c19e3a-7ebe-4e39-9455-396c12b558c8','西瓜汁','果汁',14.00,21,'口味清甜细腻',NULL,43),('4bd57c99-f316-4067-93dd-950ee41a7acd','苹果汁','果汁',15.00,69,'app1e juice',NULL,67),('5745bb1c-ed5b-40b9-8ac4-3d4a5a45e76f','鸡翅','小吃',10.00,21,'上等鸡翅，以椒盐淬之，色泽金黄、椒盐清香、咸香酥嫩。',NULL,45),('5c01fb0e-28a5-4ad2-a285-162248ab1712','美式咖啡','咖啡',16.00,31,'一杯好的Espresso',NULL,31),('7a236bdb-6235-4370-bce3-bd8391278d9d','薯条','小吃',9.00,71,'可咸可甜',NULL,54),('ab12de66-67f2-472a-b2a5-7ee5df12eeb6','珍珠奶茶','奶茶',11.00,23,'咖啡店卖奶茶难道不是常识吗？',NULL,62),('de77ac3c-28c9-4db2-9113-de9150e94f2f','摩卡咖啡','咖啡',18.00,42,'在濃縮咖啡中加入摩卡醬，與蒸煮牛奶一起交織出絲滑與醇厚。',NULL,31),('e9a11136-b39d-4341-a447-e3084e33066b','黑糖奶茶','奶茶',12.00,33,'抵擋不了誘惑！',NULL,71);
...
INSERT INTO `user_role` VALUES ('fa54097d-6d95-44df-b4b0-a2d6283d9500','ROLE_ADMIN'),('2f729779-d174-44d5-b74a-5e0797f50f92','ROLE_USER'),('468e78f3-0532-4a10-99d5-4cddf7618b11','ROLE_USER'),('8b7a0ef9-df1e-4319-a941-b1624ed6cf23','ROLE_USER'),('d3ce1d07-34f9-4333-a557-6cfdd06bdbcc','ROLE_USER');
...
-- Dump completed on 2020-07-19 19:29:49
